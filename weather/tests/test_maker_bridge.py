...
class TestExecuteMakerOrder:
    def test_maker_order_success(self):
        ...
        result = bridge.execute_maker_order("m1", "yes", 2.0, 0.10)
    ...
    def test_maker_order_rejected_crosses_spread(self):
